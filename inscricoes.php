    ...
    <div class="inscricoes">
        <div class="inscricoes-info">
            ...
            <div class="info-text">
                ...
                <p>Por aqui, você preenche o formulário de <br>inscrição para garantir para garantir sua <br>participação na recepção dos calouros de <br>Ciência da Computação e Inteligência <br>Artificial da UFMA!</p>
            </div>
        ...
        <div class="inscricoes-form">
            ...
            <div class="card-fechado" id="card-fechado" style="display: block;">
