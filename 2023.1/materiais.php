...
?>
    ...
    <section id="materials" class="wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
        ...
        <div class="container wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
            ...
            <div class="row justify-content-center">
                <div class="col-sm">
                    ...
                    <div class="speaker">
                        <center><a align="center" href="https://portalpadrao.ufma.br/proen/documentos-para-upload/guia-estudante-2023.pdf" target="_blank">
                            <button class="faq-whatsapp btn">Baixe Aqui!</button>
                        </a></center>
                    </div>
                </div>
                <div class="col-sm">
                    <h4 class="schedule-day-title">Guia do SIGAA</h4>
