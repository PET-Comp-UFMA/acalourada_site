            ...
            <div role="tabpanel" class="col-lg-9 tab-pane fade show active" id="day-1">
                ...
                <div class="infos">
                    ...
                    <div class="sub-infos">
                        ...
                        <p>Apresentador(a): Equipe PETComp<br>Local: A definir</p>
                    </div>
                </div>
                ...
                <div class="infos">
                    ...
                    <div class="sub-infos">
                        ...
                        <p>Apresentador(a): LABI<br>Local: A definirT</p>
                    </div>
                </div>
                ...
                <div class="infos">
                    ...
                    <div class="sub-infos">
                        ...
                        <p>Apresentadores: Equipe DAComp<br>Local: A definir</p>
                    </div>
                </div>
                ...
                <div class="infos">
                    ...
                    <div class="sub-infos">
                        ...
                        <p>Apresentador(a): Equipe da Atlética <br>Local: A definir</p>
                    </div>
                </div>
                ...
                <div class="infos">
                    ...
                    <img src="img/speakers/pet.jpg" alt="">
                    <div class="sub-infos">
                        <h4>Minicurso Lógica de Programação com Premiação</h4>
                        <p>Apresentador(a):Petianos José Guilherme e Breno <br>Local: A definir</p>
                    </div>
                </div>
                ...
                <div class="infos">
                    ...
                    <div class="sub-infos">
                        ...
                        <p>Apresentador(a): Prof. Geraldo Braz<br>Local: A definir</p>
                    </div>
                </div>
                ...
                <div class="infos">
                    <time>08:40-09:10</time>
                    <img src="img/labs/lsdi.png" alt="">
                    <div class="sub-infos">
                        <h4>LSDI</h4>
                        <p>Apresentador: Francisco<br>Local: Prédio da Pós</p>
                    </div>
                </div>
                ...
                <div class="infos">
                    ...
                    <div class="sub-infos">
                        <h4>LACMOR</h4>
                        <p>Apresentador: Alexandre<br>Local: Prédio da Pós</p>
                    </div>
                </div>
                ...
                <div class="infos">
                    ...
                    <div class="sub-infos">
                        <h4>LAWS</h4>
                        <p>Apresentador: Mário<br>Local: Prédio da Pós</p>
                    </div>
                </div>
                ...
                <div class="infos">
                    ...
                    <div class="sub-infos">
                        <h4>Telemídia</h4>
                        <p>Apresentador: Salles<br>Local: Prédio da Pós</p>
                    </div>
                </div>
                ...
                <div class="infos">
                    ...
                    <div class="sub-infos">
                        <h4>VipLab (Pós)</h4>
                        <p>Apresentador: Dallyson<br>Local: Prédio da Pós</p>
                    </div>
                </div>
                ...
                <div class="infos">
                    ...
                    <div class="sub-infos">
                        <h4>Inovtec</h4>
                        <p>Apresentador: Aroelino<br>Local: Prédio da Pós</p>
                    </div>
                </div>
                ...
                <div class="infos">
                    ...
                    <img src="img/speakers/pet.jpg" alt="">
                    <div class="sub-infos">
                        <h4>Mesa Redonda com os egressos</h4>
                ...
                <div class="infos">
                    ...
                    <div class="sub-infos">
                        <h4>LINT</h4>
                        <p>Apresentador: Bonini<br>Local: CCET</p>
                    </div>
                </div>

                <div class="infos">
                    <time>16:40-17:10</time>
                    <img src="img/labs/viplab.png" alt="">
                    <div class="sub-infos">
                        <h4>VipLab (DEINF)</h4>
                        <p>Apresentador: Geraldo<br>Local: CCET</p>
                    </div>
                </div>

                <div class="infos">
                    <time>17:20-17:50</time>
