...
btnDia1.addEventListener("click", () => {
    ...
    diaAtual = 1;
    banner.src = "img/registros/2026.2/BannerRegistrosDia1.svg";
...
btnDia2.addEventListener("click", () => {
    ...
    diaAtual = 2;
    banner.src = "img/registros/2026.2/BannerRegistrosDia2.svg";
    // banner.src = "img/registros/2026.2/BannerRegistrosEmBreve.svg";
...
btnDia3.addEventListener("click", () => {
    ...
    diaAtual = 3;
    banner.src = "img/registros/2026.2/BannerRegistrosDia3.svg";
    // banner.src = "img/registros/2026.2/BannerRegistrosEmBreve.svg";
...
banner.addEventListener("click", (e) => {
    ...
    if (
        ...
        boxFotos.src = `img/registros/2026.2/modalDia${diaAtual}.png`;
